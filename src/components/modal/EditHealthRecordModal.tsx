...
const EditHealthRecordModal: React.FC<EditHealthRecordModalProps> = ({onClose, onSave }) => {
  ...
  //     setRecordType(record.time || '');
  //     setResult(record.status || '');
  //     setClinician('First Name Surname');
  //     setEncoder(record.visit || '');
  //   }
  // }, [record]);
